...
public class Frontend  {
    ...
    public static native void newCpu(long handle, int hartId, String isa, String priv, int physWidth, int pmpNum, int triggerCount, int asidWidth, int memoryViewId);
